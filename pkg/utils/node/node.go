...
func GetControlPlaneNode(ctx context.Context, s state.State, name string, snap snap.Snap) (*apiv2.NodeStatus, error) {
...
func IsControlPlaneNode(ctx context.Context, s state.State, name string, snap snap.Snap) (bool, error) {
